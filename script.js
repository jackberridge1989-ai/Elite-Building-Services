...
const WHATSAPP_NUMBER = "447498480764";
...
function setupProjectModal() {
    ...
    prevButton?.addEventListener("click", () => updateGallery(activeImage - 1));
    ...
    window.addEventListener("keydown", (event) => {
        ...
        if (event.key === "ArrowLeft") updateGallery(activeImage - 1);
        if (event.key === "ArrowRight") updateGallery(activeImage + 1);
